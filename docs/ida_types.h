...
enum GAMEALLOC_BUFFER {
    MEM_BUF_TEXTURE_PAGES = 0,
    MEM_BUF_OBJECT_TEXTURES = 1,
    MEM_BUF_MESH_POINTERS = 2,
    MEM_BUF_MESHES = 3,
    MEM_BUF_ANIMS = 4,
    MEM_BUF_ANIM_CHANGES = 5,
    MEM_BUF_ANIM_RANGES = 6,
    MEM_BUF_ANIM_COMMANDS = 7,
    MEM_BUF_ANIM_BONES = 8,
    MEM_BUF_ANIM_FRAMES = 9,
    MEM_BUF_ROOM_TEXTURES = 10,
    MEM_BUF_ROOM_INFOS = 11,
    MEM_BUF_ROOM_MESH = 12,
    MEM_BUF_ROOM_DOOR = 13,
    MEM_BUF_ROOM_FLOOR = 14,
    MEM_BUF_ROOM_LIGHTS = 15,
    MEM_BUF_ROOM_STATIC_MESH_INFOS = 16,
    MEM_BUF_FLOOR_DATA = 17,
    MEM_BUF_ITEMS = 18,
    MEM_BUF_CAMERAS = 19,
    MEM_BUF_SOUND_FX = 20,
    MEM_BUF_BOXES = 21,
    MEM_BUF_OVERLAPS = 22,
    MEM_BUF_GROUNDZONE = 23,
    MEM_BUF_FLYZONE = 24,
    MEM_BUF_ANIMATING_TEXTURE_RANGES = 25,
    MEM_BUF_CINEMATIC_FRAMES = 26,
    MEM_BUF_LOADDEMO_BUFFER = 27,
    MEM_BUF_SAVEDEMO_BUFFER = 28,
    MEM_BUF_CINEMATIC_EFFECTS = 29,
    MEM_BUF_MUMMY_HEAD_TURN = 30,
    MEM_BUF_EXTRA_DOOR_STUFF = 31,
    MEM_BUF_EFFECTS = 32,
    MEM_BUF_CREATURE_DATA = 33,
    MEM_BUF_CREATURE_LOT = 34,
    MEM_BUF_SAMPLE_INFOS = 35,
    MEM_BUF_SAMPLES = 36,
    MEM_BUF_SAMPLE_OFFSETS = 37,
    MEM_BUF_ROLLINGBALL_STUFF = 38,
};
